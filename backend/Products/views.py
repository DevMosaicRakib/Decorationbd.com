...
class allProductsView(APIView):
    def get(self, request, format=None):
        allProductData = Product.objects.prefetch_related('variants__images').all()
...
class SingleProductView(APIView):
    def get(self, request, name, format=None):
        ...
        try:
            singleProductData = Product.objects.prefetch_related('variants__images').get(name=decoded_name)
