              ...
              <RxCross1 size={20} className="absolute right-10 top-3 z-50 text-white cursor-pointer" 
               onClick={()=>{setActiveNews([])}} />
                ...
                1350px:top-[25%] left-[15%] text-center'>
                  <h1 className='1024px:text-[16px] 768px:text-[14px] text-[13px] font-[500] mb-[5px] text-[#c72d2d]'>Notice :</h1>
                  <p className='1024px:text-[16px] 768px:text-[14px] text-[13px] text-[#2A2B2C] font-[600]'>{news.popupSpeech}</p>
