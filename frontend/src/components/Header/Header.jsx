...
const Header = ({dropDown,setDropDown,deviceCookie}) => {
  ...
  return (
    <>
          ...
          <div className="flex">
            <div className={`${Styles.normal_flex} 1350px:mr-[20px]`}>
              ...
              <span className="text-sm font-[400] text-white">
               <>
                      {!cartItems?.length ? '0' : Number(totalPrice)}
     ...
     border-b-[1px] border-[rgba(0,0,0,0.3)]`}>
       ...
       >
                  <CartPopup setOpencart={setOpencart} openCart={openCart} deviceCookie={deviceCookie}/>
                </div>
              </div>
            ):null
          }
