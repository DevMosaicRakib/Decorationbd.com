...
const QuickView = ({data,setOpen,open,setSelectedProduct,autoclose,deviceCookie}) => {
      ...
      {data?(
        ...
        justify-center">
            ...
            bg-white rounded-md shadow-md p-4">
                ...
                <div className=" w-full 768px:flex justify-center items-start mt-[30px]">
                      ...
                      <div className='w-full 768px:w-[50%]'>
                            ...
                            <div
                                ...
                                className="w-[295px] h-[295px] mb-2  relative"
                    ...
                    <div className='w-full 768px:w-[45%]  pl-[5px] pr-[5px] '>
                        ...
                        <div className='pt-2 mb-2'>
                            {/* Variant Section */}
                              ...
                              {Object.entries(
                                ...
                                <div className="mt-4 flex items-center gap-[5px]" key={variantType}>
                                <p className="font-medium text-gray-700 text-[13px]">
                                    Select: {/* Display the type */}
                                </p>
