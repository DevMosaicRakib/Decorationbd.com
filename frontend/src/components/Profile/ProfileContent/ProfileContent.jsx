        ...
        <table className="w-full table-auto border-collapse border border-gray-300 text-center">
          <thead>
            <tr className="bg-gray-100">
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Order Num</th>
              ...
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Product Price</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Product Weight</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Shipping Cost</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Coupon Discount</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Adv Payment</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Total Cost</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Pending Amount</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Order Status</th>
              <th className="border border-gray-300 px-4 py-2 text-[13px] font-normal text-[#242424]">Delivery Status</th>
            </tr>
          </thead>
          <tbody>
            {orders.map((order,index) => (
              <React.Fragment key={order.id}>
                <tr className="bg-white">
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424] mb-[5px]">
                    {index+1}
                    <div className="text-gray-500 text-[10px]">{order.formatted_created_date}</div>
                  </td>
                  <td className="border border-gray-300 px-1 1024px:px-4 1350px:px-1 w-[150px] py-2 flex flex-col items-center">
                    {order.order_items.map((item, index) => (
                      <div key={index} className="flex items-center mb-2">
                        ...
                        />
                        <div>
                          <span className="text-[10px] font-normal text-[#242424] mb-[5px]">{item.product.name.length>20 ? item.product.name.slice(0,19) + "..." : item.product.name}</span>
                          <div className="flex flex-col text-[10px] text-[#242424] gap-[5px] ml-2">
                            <span>Qty: {item.quantity}</span>
                            <span>Model No: {item.product.model_no}</span>
                          </div>
                        </div>
                      </div>
                    ))}
                  </td>
                  <td className="border border-gray-300 px-2 py-2 text-[10px] font-normal text-[#242424]">
                    <p>{order.shipping_address.name}</p>
                    <p>{order.shipping_address.phone}</p>
                    <p>{order.shipping_address.address}, {order.shipping_address.city}</p>
                  </td>
                  {order.order_items.map((item, index) => (
                    <td className=" px-4 py-2 text-[10px] font-normal flex flex-col text-[#242424]" key={index}>
                      <span>{item.quantity + " x " + item.product.discount_price}</span>
                    </td>
                  ))}
                  

                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">0.00</td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">
                    Standard Tk.150, <br/> Tk. 15 will increase per kg
                  </td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">0.00</td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">{order.paid_amount}</td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">{order.total_price}</td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">{Number(order.total_price-order.paid_amount).toFixed(2)}</td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">{order.payment_status}</td>
                  <td className="border border-gray-300 px-4 py-2 text-[10px] font-normal text-[#242424]">{order.status}</td>
                </tr>
    ...
    <div className="1024px:pl-8 768px:pl-3 pl-1 pt-2">
      <div className="flex items-center 768px:gap-[10px] gap-[3px] rounded-sm shadow-sm shadow-[rgb(247,214,171,0.5)] 1024px:px-2 px-1 py-1 w-full 768px:w-[85%] 1024px:w-[73%]">
        ...
        <h4 className="text-[#242424] font-[400] text-[12px]">
          ...
          <span className="hidden 768px:inline text-[12px] font-normal"> Visit our shop and choose your best products.</span>
        </h4>
        <Link to={`/shop`} className="text-[13px] font-[400] 768px:px-2 px-[5px] py-1 hover:underline text-black bg-transparent border-[1px] border-[rgb(128,128,128,0.4)] outline-none rounded-sm ml-[3px] 768px:ml-0">
          Visit shop
        </Link>
      </div>
