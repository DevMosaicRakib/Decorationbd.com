...
const ShopStickyCategory = () => {
  ...
  return (
    <>
    <div className='1300px:w-[340px] w-[270px] bg-[#fff] h-auto'style={{
    ...
    }}>
      {
        categories?.map((item)=>(
            ...
            onMouseLeave={() => setHoveredCategory(null)}>
             ...
             <ImArrowRight  className='ml-[15px] text-[16px]'/>
            <h3 className='m-3 cursor-pointer select-none h-full font-[400]'>{item.catname}</h3>
             </div>
