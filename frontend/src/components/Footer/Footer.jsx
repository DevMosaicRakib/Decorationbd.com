    ...
    <div className={`footerSection`}>
      ...
      {/* <div className="w-full bg-[#000000] h-[10%]">
        ...
        <div className="w-full bg-[#000000] h-[10%]">
          ...
          text-[13px] h-[65px] 768px:h-[50px] text-[#d4d5d5] font-[400] flex 300px:flex-col 768px:flex-row items-center justify-center">
            <span className="text-[12px] text-[#d4d5d5] 
            flex-1 text-center 768px:ml-[170px] 1024px:ml-[200px]">all rights reserved © 2020 - 2024 decorationbd.com</span>
            <div className="mr-[5px]">
              <span className="text-[12px] text-[#d4d5d5]">Developed by : Md. Rakib Hasan Khan</span>
              <span className="flex items-center justify-center gap-[10px]">
                <span className="text-[12px] text-[#d4d5d5]">Contact :</span>
                <a href="https://github.com/DevMosaicRakib"><img src={github} alt="github" className="w-[18px] h-[18px] overflow-hidden rounded-[50%] bg-[#fff]"/></a>
                <a href="https://www.linkedin.com/in/md-rakib-hasan-khan-6593a1324/"><img src={linkedin} alt="linkedin" className="w-[18px] h-[18px] overflow-hidden rounded-[50%] bg-[#fff]"/></a>
                <a href="https://wa.me/01747065190"><img src={whatsapp} alt="whatsapp" className="w-[18px] h-[18px] overflow-hidden rounded-[50%] bg-[#fff]"/></a>
              </span>
            </div>
          </div>
        </div>
